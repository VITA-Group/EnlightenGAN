...
if opt.train:
	os.system("python train.py \
		--dataroot /ssd1/yifan/final_dataset_del \
		--no_dropout \
		--name single_unet_conv_add_vary_Tresidual_attention_bs32_BN_nonormDlayer5_4_final_del_ragan_lsgan_32D_PV_5_vgg_relu5_2 \
		--model single \
	...
	for i in range(3):
	        os.system("python compare.py \
	        	--dataroot /hdd2/yifan/final_test \
	        	--name single_unet_conv_add_vary_Tresidual_attention_bs32_BN_nonormDlayer5_4_final_del_ragan_lsgan_32D_PV_5_vgg_relu5_2 \
	        	--model single \
	        	--which_direction AtoB \
	        	--no_dropout \
