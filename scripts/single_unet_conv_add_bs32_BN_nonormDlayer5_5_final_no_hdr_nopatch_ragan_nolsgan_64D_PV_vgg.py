...
if opt.train:
	os.system("python train.py \
		...
		--no_dropout \
		--name single_unet_conv_add_bs32_BN_nonormDlayer5_5_final_no_hdr_nopatch_ragan_nolsgan_64D_PV_vgg \
		--model single \
	...
	for i in range(20):
	        os.system("python test.py \
	        	...
	        	--name single_unet_conv_add_bs32_BN_nonormDlayer5_5_final_no_hdr_nopatch_ragan_64D_PV_vgg \
	        	--model single \
