...
if opt.train:
	os.system("python train.py \
		--dataroot /home/yifan/edark_final \
		--no_dropout \
		--name single_unet_conv_add_vary_Tresidual_attention_bs32_BN_nonormDlayer5_4_edark_final_ragan_lsgan_32D_PV_5_vgg_relu5_1 \
		--model single \
