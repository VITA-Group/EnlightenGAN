...
if opt.train:
	os.system("python train.py \
		--dataroot /home/yifan/BBD_final \
		--no_dropout \
		--name single_unet_conv_add_vary_Tresidual_attention_bs32_BN_nonormDlayer5_4_BBD_final_ragan_lsgan_32D_PV_5_vgg_relu5_1 \
		--model single \
	...
	for i in range(3):
	        os.system("python compare.py \
	        	--dataroot /home/yifan/test_dataset \
	        	--name single_unet_conv_add_vary_Tresidual_attention_bs32_BN_nonormDlayer5_4_BBD_final_ragan_lsgan_32D_PV_5_vgg_relu5_1 \
	        	--model single \
	        	--which_direction AtoB \
	        	--no_dropout \
